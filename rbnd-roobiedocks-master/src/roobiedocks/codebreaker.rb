...
# 0) First character removed (chop off last character in reversed code),
code = code.reverse.chop.reverse

# 1,2) insert "A EW? O" at pos 11, delete "Q", "?", and ","
code = code.insert(11, "A EW? 0").delete("Q?,")

# 3,4,5) lower case, reverse, and capitalize the firt letter of the code.
